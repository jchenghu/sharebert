...
from pretraining.modeling import ShareBertForPreTraining as ShareBertForPreTraining
from pretraining.modeling import ShareBertLMHeadModel as ShareBertLMHeadModel
...
MODELS = {
    "bert-mlm": (ShareBertLMHeadModel, PretrainedBertConfig, BertTokenizer),
    "bert-mlm-roberta": (ShareBertLMHeadModel, PretrainedRobertaConfig, RobertaTokenizer),
    "bert-mlm-nsp": (ShareBertForPreTraining, PretrainedBertConfig, BertTokenizer),
}
